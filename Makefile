all: rails/all laravel/all django/all serverless/all
...
serverless/all: serverless/python3.8/image serverless/python3.9/image # serverless/python3.10/image serverless/python3.11/image
